...
def newton_raphson(f, x0=0.0, tol=1e-8, alp=1e-2, maxiter=1e3):
...
""" Function 'newtonraphson_plot' plots the objective function along with the minimum """

def newtonraphson_plot(xn, f):
...
if __name__ == "__main__":
    ...
    # Input Values for the 'newton_raphson' function
